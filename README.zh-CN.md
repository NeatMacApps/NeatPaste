...
从 [Releases](https://github.com/NeatMacApps/NeatPaste/releases/latest) 页面下载最新的**已签名并公证**的 `NeatPaste-x.y.z.dmg`，把 NeatPaste 拖进「应用程序」即可。

NeatPaste 会自动检查更新（内置 [Sparkle](https://sparkle-project.org)）；菜单栏菜单里也有「检查更新…」入口。
